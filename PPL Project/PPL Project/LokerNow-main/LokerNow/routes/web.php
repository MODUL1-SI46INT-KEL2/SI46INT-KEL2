...
use App\Http\Controllers\JobInsightController;

Route::middleware(['auth'])->prefix('job-insight')->name('job-insight.')->group(function () {
    Route::get('/', [JobInsightController::class, 'index'])->name('index');
    Route::get('/salary-estimate', [JobInsightController::class, 'salaryEstimate'])->name('salary-estimate');
    Route::get('/industry-trends', [JobInsightController::class, 'industryTrends'])->name('industry-trends');
    Route::get('/career-path', [JobInsightController::class, 'careerPath'])->name('career-path');
});

Route::prefix('jobinsight')->group(function () {
    Route::get('/salary', [JobInsightController::class, 'salary'])->name('jobinsight.salary');
    Route::get('/industry', [JobInsightController::class, 'industry'])->name('jobinsight.industry');
    Route::get('/career-path', [JobInsightController::class, 'careerPath'])->name('jobinsight.careerpath');
});
