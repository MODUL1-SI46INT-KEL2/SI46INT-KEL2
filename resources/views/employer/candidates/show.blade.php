        ...
        <div class="bg-gradient-to-r from-gray-900 to-gray-800 p-6 pb-32">
            <div class="flex justify-between items-start">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <!-- TODO: Review UX - candidate favorite system -->
                    <button onclick="toggleFavoriteCandidate({{ $candidate->id }}, '{{ $candidate->name }}')" 
                            class="favorite-button opacity-0 absolute pointer-events-none bg-gray-700 hover:bg-gray-600 text-gray-400 px-4 py-2 rounded-lg inline-flex items-center transition-colors"
                            data-candidate-id="{{ $candidate->id }}"
